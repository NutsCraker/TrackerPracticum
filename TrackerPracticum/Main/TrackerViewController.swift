...
final class TrackersViewController: UIViewController {
    ...
    private let filtersButtonTitle = NSLocalizedString("filters", tableName: "Localizable", comment: "Title Trackers")
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(TrackersCollectionView.self,
...
extension TrackersViewController: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, previewForHighlightingContextMenuWithConfiguration configuration: UIContextMenuConfiguration) -> UITargetedPreview? {
        ...
        guard let cell = collectionView.cellForItem(at: indexPath) as? TrackersCollectionView else { return nil }
