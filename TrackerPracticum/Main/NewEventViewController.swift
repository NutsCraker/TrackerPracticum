...
class NewEventViewController: UIViewController {
    ...
    public weak var delegate: NewEventViewControllerDelegate?
    ...
    private var createEventView: UIView = {
        let view = UIView()
    ...
    private var forwardImage1: UIImageView = {
    ...
    private var forwardImage2: UIImageView = {
        let forwardImage = UIImageView()
        forwardImage.image = UIImage(named: "chevronForward")
        forwardImage.translatesAutoresizingMaskIntoConstraints = false
        return forwardImage
    ...
    private var scheduleButtonTitle: UILabel = {
        let label = UILabel()
        label.textColor = .black
    ...
    private var scheduleButtonSubTitle: UILabel = {
        let label = UILabel()
...
extension NewEventViewController: WeekdayCellDelegate? {
